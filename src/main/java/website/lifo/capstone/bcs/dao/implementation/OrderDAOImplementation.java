...
import website.lifo.capstone.bcs.entity.Order;
import website.lifo.capstone.bcs.entity.OrderDetail;
import website.lifo.capstone.bcs.entity.Product;
import website.lifo.capstone.bcs.model.CartInfo;
import website.lifo.capstone.bcs.model.CartLineItemInfo;
...
public class OrderDAOImplementation implements OrderDAO {
    ...
    public void saveOrder(CartInfo cartInfo) {
        ...
        List<CartLineItemInfo> lines = cartInfo.getCartLines();
    ...
    public PagingResult<OrderInfo> listOrderInfo(int page, int maxResult, int maxNavigationPage) {
        ...
        return new PagingResult<OrderInfo>(query, page, maxResult, maxNavigationPage);
    }
